...
package net.mcreator.nether.world;
...
public class WorldNetherNew extends ElementsNetherMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("nether:nether_new_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldNetherNew(ElementsNetherMod instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemNetherNew().setUnlocalizedName("nether_new").setRegistryName("nether_new"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension nether_new is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("nether_new", "_nether_new", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemNetherNew.block, 0, new ModelResourceLocation("nether:nether_new", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("nether_new_portal");
			setRegistryName("nether_new_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE3 = BlockNewNetherRack.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("nether:warpedforest")),
				Biome.REGISTRY.getObject(new ResourceLocation("nether:crimsonforest")),
				Biome.REGISTRY.getObject(new ResourceLocation("nether:basalt_delta")),};
