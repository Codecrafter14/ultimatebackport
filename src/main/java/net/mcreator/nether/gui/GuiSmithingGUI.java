...
import net.mcreator.nether.procedure.ProcedureTaken;
...
public class GuiSmithingGUI extends ElementsNetherMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiSmithingGUI(ElementsNetherMod instance) {
		super(instance, 82);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 17, 55) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 73, 55) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 139, 55) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nether:textures/smithing_gui.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			zLevel = 100.0F;
			this.mc.renderEngine.bindTexture(new ResourceLocation("nether:textures/gui3.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 2, this.guiTop + 11, 0, 0, 39, 36, 39, 36);
			this.mc.renderEngine.bindTexture(new ResourceLocation("nether:textures/gui2.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 98, this.guiTop + 54, 0, 0, 25, 17, 25, 17);
			this.mc.renderEngine.bindTexture(new ResourceLocation("nether:textures/gui1.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 48, this.guiTop + 56, 0, 0, 13, 13, 13, 13);
		}
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Smithing table", 47, 8, -12829636);
		}
		...
		if (slotID == 2 && changeType == 1) {
			{
				...
				ProcedureTaken.executeProcedure($_dependencies);
			}
		}
