...
public class BlockWarpedSlab extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:warped_slab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("nether:warped_slab_double")
	public static final Block block_slab_double = null;
	public BlockWarpedSlab(ElementsNetherMod instance) {
		super(instance, 111);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("warped_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("warped_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:warped_slab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("warped_slab");
