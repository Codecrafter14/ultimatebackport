...
public class BlockCrimsonSlab extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:crimson_slab")
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("crimson_slab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("crimson_slab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:crimson_slab", "inventory"));
	}
