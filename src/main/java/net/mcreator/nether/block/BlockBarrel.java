...
import net.mcreator.nether.procedure.ProcedureBarrelOnBlockRightClicked;
...
public class BlockBarrel extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:barrel")
	public static final Block block = null;
	public BlockBarrel(ElementsNetherMod instance) {
		super(instance, 107);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("barrel"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "nether:tileentitybarrel");
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:barrel", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			if (entity instanceof EntityPlayer) {
				((EntityPlayer) entity).openGui(NetherMod.instance, GuiBarrelGUI.GUIID, world, x, y, z);
			}
			{
				...
				ProcedureBarrelOnBlockRightClicked.executeProcedure($_dependencies);
			}
			return true;
		}
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getGuiID() {
			return "nether:barrel";
		}

		@Override
		public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
			return new GuiBarrelGUI.GuiContainerMod(this.getWorld(), this.getPos().getX(), this.getPos().getY(), this.getPos().getZ(), playerIn);
		}
