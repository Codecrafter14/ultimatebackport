...
public class BlockWarpedFungus extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:warped_fungus")
	public static final Block block = null;
	public BlockWarpedFungus(ElementsNetherMod instance) {
		super(instance, 34);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:warped_fungus", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("warped_fungus");
