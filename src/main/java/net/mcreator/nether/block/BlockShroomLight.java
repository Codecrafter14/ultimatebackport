...
public class BlockShroomLight extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:shroom_light")
	public static final Block block = null;
	public BlockShroomLight(ElementsNetherMod instance) {
		super(instance, 17);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("shroom_light"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:shroom_light", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("shroom_light");
