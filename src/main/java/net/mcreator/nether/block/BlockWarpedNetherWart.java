...
public class BlockWarpedNetherWart extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:warped_nether_wart")
	public static final Block block = null;
	public BlockWarpedNetherWart(ElementsNetherMod instance) {
		super(instance, 19);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("warped_nether_wart"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nether:warped_nether_wart", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("warped_nether_wart");
