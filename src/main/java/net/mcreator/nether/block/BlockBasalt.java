...
public class BlockBasalt extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:basalt")
	public static final Block block = null;
	public BlockBasalt(ElementsNetherMod instance) {
		super(instance, 10);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:basalt", "inventory"));
	}
