...
public class BlockWarpedRoots extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:warped_roots")
	public static final Block block = null;
	public BlockWarpedRoots(ElementsNetherMod instance) {
		super(instance, 122);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:warped_roots", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("warped_roots");
			setRegistryName("warped_roots");
		}
