...
public class BlockTwistingVines extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:twisting_vines")
	public static final Block block = null;
	public BlockTwistingVines(ElementsNetherMod instance) {
		super(instance, 33);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:twisting_vines", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("twisting_vines");
			setRegistryName("twisting_vines");
		}
