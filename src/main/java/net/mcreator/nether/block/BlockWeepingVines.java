...
public class BlockWeepingVines extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:weeping_vines")
	public static final Block block = null;
	public BlockWeepingVines(ElementsNetherMod instance) {
		super(instance, 85);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:weeping_vines", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("weeping_vines");
			setRegistryName("weeping_vines");
		}
