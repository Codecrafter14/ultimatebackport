...
public class BlockCrimsonNylium extends ElementsNetherMod.ModElement {
	@GameRegistry.ObjectHolder("nether:crimson_nylium")
	public static final Block block = null;
	public BlockCrimsonNylium(ElementsNetherMod instance) {
		super(instance, 20);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("nether:crimson_nylium", "inventory"));
	}
