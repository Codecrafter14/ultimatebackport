...
import net.mcreator.nether.procedure.ProcedurePiglinNormalRightClickedOnEntity;
...
public class EntityPiglinNormal extends ElementsNetherMod.ModElement {
	...
	public EntityPiglinNormal(ElementsNetherMod instance) {
		super(instance, 36);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("nether", "piglin_normal"), ENTITYID)
						.name("piglin_normal").tracker(64, 3, true).egg(-26215, -16737997).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelpiglin(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("nether:textures/piglin.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("nether:mob.piglin.ambient"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("nether:mob.piglin.hurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("nether:mob.piglin.death"));
		}
		...
		public boolean processInteract(EntityPlayer entity, EnumHand hand) {
			...
			ItemStack itemstack = entity.getHeldItem(hand);
			{
				...
				ProcedurePiglinNormalRightClickedOnEntity.executeProcedure($_dependencies);
			}
			return true;
		}
	...
	public static class Modelpiglin extends ModelBase {
		...
		public Modelpiglin() {
			...
			LeftEar.cubeList.add(new ModelBox(LeftEar, 51, 6, 0.0F, 0.0F, -2.0F, 1, 5, 4, 0.0F, false));
			RightEar = new ModelRenderer(this);
			RightEar.setRotationPoint(-4.5F, -6.0F, 0.0F);
			Head.addChild(RightEar);
			setRotationAngle(RightEar, 0.0F, 0.0F, 0.4363F);
			RightEar.cubeList.add(new ModelBox(RightEar, 39, 6, -1.0F, 0.0F, -2.0F, 1, 5, 4, 0.0F, false));
