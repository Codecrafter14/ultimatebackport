...
public class EntityZombiePiglin extends ElementsNetherMod.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;
	public EntityZombiePiglin(ElementsNetherMod instance) {
		super(instance, 38);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("nether", "zombie_piglin"), ENTITYID)
						.name("zombie_piglin").tracker(64, 3, true).egg(-26215, -16724992).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelpiglin(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("nether:textures/zombie_piglin.png");
				}
			};
		});
	}
